...
function [OUT] = func_flux_insol(grid,time,OUT)
...
OUT.TOAflat = OUT.I0.*(sin(grid.lat_mask*pi/180.0).*sin(d*pi/180.0) + cos(grid.lat_mask*pi/180.0).*cos(d*pi/180.0).*cos(h*pi/180.0));
